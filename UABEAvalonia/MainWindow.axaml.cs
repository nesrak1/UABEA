    ...
    public class MainWindow : Window
    {
        ...
        private async void BtnRemove_Click(object? sender, RoutedEventArgs e)
        {
            if (bundleInst != null && comboBox.SelectedItem != null)
            {
                ...
                if(index < bundleInst.file.bundleInf6.dirInf.Length) // Pre-existing index
                {
                    string bunAssetName = bundleInst.file.bundleInf6.dirInf[index].name;
                    newFiles.Add(bunAssetName, new BundleRemover(bunAssetName, true));
                }
                else // this index was most likely imported and hasn't been saved
                {
